...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex w-full cursor-default select-none items-center rounded-sm py-1.5 pl-8 pr-2 text-sm outline-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 data-[highlighted]:bg-muted data-[highlighted]:text-foreground dark:data-[highlighted]:bg-card dark:data-[highlighted]:text-white data-[state=checked]:bg-muted data-[state=checked]:text-foreground dark:data-[state=checked]:bg-card dark:data-[state=checked]:text-white",
      className
    )}
    {...props}
  >
