  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button variant="ghost" size="sm" className="w-8 h-8 sm:w-9 sm:h-9 px-0">
          ...
          <Palette className="absolute h-4 w-4 sm:h-[1.2rem] sm:w-[1.2rem] rotate-90 scale-0 transition-all data-[state=pink]:rotate-0 data-[state=pink]:scale-100" />
